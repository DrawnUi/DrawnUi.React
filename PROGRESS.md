...
7. ~~`LoadMore`, structure-preserving inserts~~ done; `ItemsSourceWindow` judged unnecessary (see SKIPPED) → `SkiaEditor`/text input, `SkiaSlider`/`SkiaSwitch`/`SkiaCheckbox`, shadows/effects.
